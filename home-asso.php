			...
			<div class="content-center-top">
				<div class="content-center-left">
					...
					<ul class="list1">
					   ...
					   <li class="pucePicto4"><b>Des stages intensifs pour les scolaires à chaque période de vacances.</b></li>
					   <li class="pucePicto3">Un atelier d’éveil à l’anglais pour les enfants dès 4 ans.<br><br></li>
					   <li class="pucePicto3">Un atelier initiation à l’anglais pour les séniors.</li>
					</ul>
					</span>
					...
					<div class="content-center-right-bottom">
						...
						<div id="table3" style="margin-left: 30px;">
						   <div class="row3">
						      ...
						      <span class="cell3"><a  href="images/ficheinscription2.pdf" target="_blank">Télécharger le formulaire d'inscription</a></span>
						   </div>
						</div>	
					</div>
