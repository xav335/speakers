				...
				<form name="formulaire" class="form-horizontal" method="POST"  action="formprocess.php">
					...
					<div class="form-group" >
						...
						<select name="type" size="1">
							<?php if ($type==0) { ?>
	           					<option selected value="0">Actu Association</option>
	           					<option value="1">Actu Professionel</option>
	           				<?php  } else { ?>
	           					<option value="0">Actu Association</option>
	           					<option selected value="1">Actu Professionel</option>
	           				<?php  }  ?>	
        				</select> 	
					</div>
					<div class="form-group" >
